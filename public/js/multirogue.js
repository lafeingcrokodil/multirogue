...
(function() {
  ...
  Screen = (function() {
    ...
    Screen.prototype.display = function(arg) {
      ...
      this.context.clearRect(this.getX(col) - 1, this.getY(row - 1) + 2, this.getTextWidth(text), this.charHeight);
    ...
    Screen.prototype.displayNarration = function(message) {
      ...
      this.context.clearRect(0, 3, this.width, this.charHeight + 1);
    ...
    Screen.prototype.displayStats = function(stats) {
      ...
      statStr += "Exp: " + exp;
      this.context.clearRect(0, this.getY(this.rows - 1) + 2, this.width, this.charHeight + 1);
